    ...
    >
      ...
      <FadeIn duration={1024}>
        ...
        >
          ...
          makers around the world. <strong>We'd love you to join us!</strong>
        </Text>
        <Button
          as="a"
          variant="ctaLg"
      ...
      <Container>
        ...
        <Box sx={{ display: 'flex' }}>
          <Text as="p" variant="lead" sx={{ flex: 1 }}>
            People learn best by making things they care about and sharing them
            with others. Hack Club is a non-profit which helps teens do this. We
            run an online community for technical teens, offer access to
            financial services to run real life events like hackathons and
            coding clubs, and involve teenagers in building open-source projects
            like a{' '}
            <Link href="https://github.com/hackclub/puzzlelab/">
              handheld console
            </Link>
            , a <Link href="https://hackclub.com/bank/">bank</Link>, a{' '}
            <Link href="https://github.com/hackclub/some-assembly-required">
